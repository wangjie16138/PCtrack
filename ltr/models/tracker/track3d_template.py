...
from .. import backbones_2d, backbones_3d, neck, reg_head, motion_offset_predictor
...
class Track3DTemplate(nn.Module):
    def __init__(self, model_cfg, num_class, dataset):
        ...
        self.module_topology = [
            'motion_offset_predictor', 'vfe', 'backbone_3d', 'map_to_bev_module',
    ...
    def build_motion_predictor(self, model_info_dict):
        ...
        motion_predictor_module = motion_offset_predictor.__all__[self.model_cfg.MOTION_PREDICTOR.NAME](
