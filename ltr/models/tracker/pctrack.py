...
class PCtrack(Track3DTemplate):
    ...
    def post_processing(self, batch_dict):
        shape_x, shape_y, _ = batch_dict['motion_preds'][0].shape#（64，64，2）
        center_x, center_y = int(shape_x / 2), int(shape_y / 2)#（32，32）
        ...
        ############################
        corner_off = batch_dict['predicted_box_corner_offset'][0, 0, :].reshape(3, 15).detach().cpu().numpy()
