...
class CenterHead(CenterHeadTemplate):
    ...
    def assign_targets(self, input_dict):
        ...
        local_gt = local_gt.unsqueeze(1) # (B, 1, 8)
    ...
    def forward(self, batch_dict):
        ...
        z_preds = z_preds.permute(0, 2, 3, 1).contiguous()
        ry_preds = ry_preds.permute(0, 2, 3, 1).contiguous()
        whl_preds = whl_preds.permute(0, 2, 3, 1).contiguous()
