...
class MeanVFE(VFETemplate):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        Args:
            batch_dict:
                voxels: (num_voxels, max_points_per_voxel, C)(N,5,4)
        ...
        template_points_mean = template_points_mean / template_normalizer  # 获得每个voxel的平均x\y\z\intensity特征
        batch_dict['template_voxel_features'] = template_points_mean.contiguous()#(N,4)
        ...
        batch_dict['search_voxel_features'] = search_points_mean.contiguous()#(N,4)
