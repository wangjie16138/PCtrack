...
from ltr.config import cfg, cfg_from_list, cfg_from_yaml_file, log_config_to_file
from ltr.datasets import build_dataloader
from ltr.models import build_network, model_fn_decorator
from ltr.utils import common_utils
...
def main():
    ...
    #######################
    end_time = time.time()
    print('Dataloader total time:', end_time - start_time)
    # ==========Model Init==========
